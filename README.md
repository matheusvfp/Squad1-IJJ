...
## Visão Geral
Este repositório contém projetos desenvolvidos pelo QA Avengers no curso de QA módulo avançado. O objetivo principal é praticar entregando as tarefas solicitadas, utilizando Python e boas práticas de desenvolvimento.
